#ifndef basic_dpd_engine_v8_raw_hpp
#define basic_dpd_engine_v8_raw_hpp

#include "dpd/engines/basic/basic_dpd_engine.hpp"

#include "dpd/engines/basic/basic_dpd_engine_v8_raw_handlers.hpp"
...
public:
    ...
    {
        b.id=BeadHash::construct(is_monomer, polymer_id, polymer_offset, bead_type).hash;
    }
