...
public:
    ...
    static void register_tests()
    {
        ...
        add({0,0,0}, {-0.4,0,0}, {0.4,0.1,0}, 20, 0.55, 0.0);
        add({0,0,0}, {-0.4,0,0}, {0.4,0.1,0}, 20, 0.55, 0.1);
        add({0,0,0}, {-0.4,0,0}, {0.4,0.1,0}, 20, 0.55, 0.2);

        add({0,0,0}, {-0.4,0,0}, {0.3,0.2,0}, 20, 0.55, 0.0);
        add({0,0,0}, {-0.4,0,0}, {0.3,0.2,0}, 20, 0.55, 0.1);
        add({0,0,0}, {-0.4,0,0}, {0.3,0.1,0}, 20, 0.55, 0.2);

        add({0,0,0}, {-0.4,0,0}, {0.2,0.1,0.2}, 20, 0.55, 0.0);
        add({0,0,0}, {-0.4,0,0}, {0.2,0.1,0.2}, 20, 0.55, 0.1);
        add({0,0,0}, {-0.4,0,0}, {0.2,0.1,0.2}, 20, 0.55, 0.2);


        add(rp(), {-0.4,0,0}, {0.4,0.1,0}, 20, 0.55, 0.0);
        add(rp(), {-0.4,0,0}, {0.4,0.1,0}, 20, 0.55, 0.1);
        add(rp(), {-0.4,0,0}, {0.4,0.1,0}, 20, 0.55, 0.2);

        add(rp(), {-0.4,0,0}, {0.3,0.2,0}, 20, 0.55, 0.0);
        add(rp(), {-0.4,0,0}, {0.3,0.2,0}, 20, 0.55, 0.1);
        add(rp(), {-0.4,0,0}, {0.3,0.1,0}, 20, 0.55, 0.2);

        add(rp(), {-0.4,0,0}, {0.2,0.1,0.2}, 20, 0.55, 0.0);
        add(rp(), {-0.4,0,0}, {0.2,0.1,0.2}, 20, 0.55, 0.1);
        add(rp(), {-0.4,0,0}, {0.2,0.1,0.2}, 20, 0.55, 0.2);
