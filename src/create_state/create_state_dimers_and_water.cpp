...
int main(int argc, const char *argv[])
{
    ...
    */
    ...
    builder.set_default_interaction_strengths(100.0, 4.0);

    builder.add_bead_type("W");
    builder.add_bead_type("A");
    builder.add_bead_type("B");
    
    builder.set_interaction_strength("A", "W", 200.0, 4.0);
    builder.set_interaction_strength("B", "W", 50.0, 4.0);

    builder.add_polymer_type("W", {"W"}, {}, {});
    builder.add_polymer_type("P", {"A","B"}, {{100.0,r0, 0,1}}, {});
