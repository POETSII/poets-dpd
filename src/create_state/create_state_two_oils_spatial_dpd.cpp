...
int main(int argc, const char *argv[])
{
    ...
    auto varying=parse_expression("10+ux*20");

    builder.set_interaction_strength("W", "W", 10.0, 10.0);
    builder.set_interaction_strength("W", "A", 20.0, 10.0);
    builder.set_interaction_strength("A", "A", 10.0, 10.0);
